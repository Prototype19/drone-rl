# Drone RL Project Specification — ARCHIVED (superseded by SPEC.md)

> **⚠️ ARCHIVE NOTICE (2026-06-16):** This is the original phase-based spec, kept verbatim for history. It was migrated to the milestone/verifier template via `/spec-interview`. **`SPEC.md` is now the source of truth.** Do not edit this file; consult it only for the original rationale behind a decision.
